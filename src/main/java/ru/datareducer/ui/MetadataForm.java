...
public class MetadataForm extends StackPane implements ModelReplacedListener {
    ...
    public void initialize() {
        nameCol.setCellFactory(new Callback<TreeTableColumn<DataServiceEntity, String>, TreeTableCell<DataServiceEntity, String>>() {
            ...
            private final Image fldImg = new Image(getClass().getClassLoader().getResourceAsStream("image/application_control_bar.png"));
            // Пиктограмма Табличных частей
            private final Image tblImg = new Image(getClass().getClassLoader().getResourceAsStream("image/application_view_detail.png"));
            // Пиктограмма Остатков
            private final Image balImg = new Image(getClass().getClassLoader().getResourceAsStream("image/chart_bar.png"));
            // Пиктограмма Оборотов
            private final Image tovImg = new Image(getClass().getClassLoader().getResourceAsStream("image/coins.png"));
            // Пиктограмма Остатков и оборотов
            private final Image batImg = new Image(getClass().getClassLoader().getResourceAsStream("image/finance.png"));
            // Пиктограмма Среза последних
            private final Image sllImg = new Image(getClass().getClassLoader().getResourceAsStream("image/formatting_greater_than.png"));
            // Пиктограмма Среза первых
            private final Image slfImg = new Image(getClass().getClassLoader().getResourceAsStream("image/formatting_less_than.png"));
            // Пиктограмма Субконто регистра бухгалтерии
            private final Image exdImg = new Image(getClass().getClassLoader().getResourceAsStream("image/barchart.png"));
            // Пиктограмма Движений с субконто регистра бухгалтерии
            private final Image rwdImg = new Image(getClass().getClassLoader().getResourceAsStream("image/table_chart.png"));
            // Пиктограмма Оборотов ДкКт регистра бухгалтерии
            private final Image tdcImg = new Image(getClass().getClassLoader().getResourceAsStream("image/chart_stock.png"));
            // Пиктограмма Данных графика регистра расчета
            private final Image csdImg = new Image(getClass().getClassLoader().getResourceAsStream("image/table.png"));
            // Пиктограмма Фактического периода действия регистра расчета
            private final Image capImg = new Image(getClass().getClassLoader().getResourceAsStream("image/table_split.png"));
            // Пиктограмма Перерасчетов
            private final Image recImg = new Image(getClass().getClassLoader().getResourceAsStream("image/arrow_rotate_clockwise.png"));
            // Пиктограмма Базовых данных регистра расчета
            private final Image crrImg = new Image(getClass().getClassLoader().getResourceAsStream("image/formatting_dublicate_value.png"));
            ...
            public TreeTableCell<DataServiceEntity, String> call(TreeTableColumn<DataServiceEntity, String> param) {
                return new TreeTableCell<DataServiceEntity, String>() {
                    private final ImageView fldImgView = new ImageView((fldImg));
                    private final ImageView tblImgView = new ImageView((tblImg));
                    private final ImageView balImgView = new ImageView((balImg));
                    private final ImageView tovImgView = new ImageView((tovImg));
                    private final ImageView sllImgView = new ImageView((sllImg));
                    private final ImageView slfImgView = new ImageView((slfImg));
                    private final ImageView batImgView = new ImageView((batImg));
                    private final ImageView exdImgView = new ImageView((exdImg));
                    private final ImageView rwdImgView = new ImageView((rwdImg));
                    private final ImageView tdcImgView = new ImageView((tdcImg));
                    private final ImageView csdImgView = new ImageView((csdImg));
                    private final ImageView capImgView = new ImageView((capImg));
                    private final ImageView recImgView = new ImageView((recImg));
                    private final ImageView crrImgView = new ImageView((crrImg));
    ...
    private void registerEventHandlers() {
        loadMetadataTreeService.setOnSucceeded(e -> {
            ...
            // Задачи
            for (ru.datareducer.dataservice.entity.Task task : metadataTree.getTasks()) {
