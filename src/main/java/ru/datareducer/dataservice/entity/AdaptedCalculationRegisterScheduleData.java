...
/**
 * Класс для маршалинга неизменяемых объектов CalculationRegisterScheduleData
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "CalculationRegisterScheduleData")
@XmlType(name = "CalculationRegisterScheduleData")
public class AdaptedCalculationRegisterScheduleData {
    private String name;
