    ...
    public Object parseValue(String value) {
        ...
        switch (this) {
            case STRING:
                return value;
            case DATETIME:
                LocalDateTime ldt = LocalDateTime.parse(value, DataServiceClient.DATE_TIME_FORMATTER);
                return ldt.atZone(DataServiceClient.DATE_TIME_FORMATTER.getZone()).toInstant();
            case SHORT:
