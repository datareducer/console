...
/**
 * Класс для маршалинга неизменяемых объектов AccountingRegisterBalance
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccountingRegisterBalance")
@XmlType(name = "AccountingRegisterBalance")
public class AdaptedAccountingRegisterBalance {
    private String name;
