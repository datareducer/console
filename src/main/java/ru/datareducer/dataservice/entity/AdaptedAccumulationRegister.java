...
/**
 * Класс для маршалинга неизменяемых объектов AccumulationRegister
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccumulationRegister")
@XmlType(name = "AccumulationRegister")
public class AdaptedAccumulationRegister {
    private String name;
