...
/**
 * Класс для маршалинга неизменяемых объектов ChartOfAccounts
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "ChartOfAccounts")
@XmlType(name = "ChartOfAccounts")
public class AdaptedChartOfAccounts {
    private String name;
