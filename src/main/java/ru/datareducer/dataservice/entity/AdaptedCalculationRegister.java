...
/**
 * Класс для маршалинга неизменяемых объектов CalculationRegister
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "CalculationRegister")
@XmlType(name = "CalculationRegister")
public class AdaptedCalculationRegister {
    private String name;
