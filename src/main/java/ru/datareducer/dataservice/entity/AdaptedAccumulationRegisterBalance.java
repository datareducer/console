...
/**
 * Класс для маршалинга неизменяемых объектов AccumulationRegisterBalance
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccumulationRegisterBalance")
@XmlType(name = "AccumulationRegisterBalance")
public class AdaptedAccumulationRegisterBalance {
    private String name;
