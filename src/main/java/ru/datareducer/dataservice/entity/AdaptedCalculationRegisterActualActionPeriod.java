...
/**
 * Класс для маршалинга неизменяемых объектов CalculationRegisterActualActionPeriod
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "CalculationRegisterActualActionPeriod")
@XmlType(name = "CalculationRegisterActualActionPeriod")
public class AdaptedCalculationRegisterActualActionPeriod {
    private String name;
