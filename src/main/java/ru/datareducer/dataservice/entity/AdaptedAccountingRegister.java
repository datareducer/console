...
/**
 * Класс для маршалинга неизменяемых объектов AccountingRegister
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccountingRegister")
@XmlType(name = "AccountingRegister")
public class AdaptedAccountingRegister {
    private String name;
