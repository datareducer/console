...
/**
 * Класс для маршалинга неизменяемых объектов TabularSection
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "TabularSection")
@XmlType(name = "TabularSection")
public class AdaptedTabularSection {
    private String name;
    private DataServiceEntity parent;
    ...
    public void setParent(DataServiceEntity parent) {
        this.parent = parent;
    }
}
