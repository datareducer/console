...
/**
 * Класс для маршалинга неизменяемых объектов AccountingRegisterDrCrTurnovers
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccountingRegisterDrCrTurnovers")
@XmlType(name = "AccountingRegisterDrCrTurnovers")
public class AdaptedAccountingRegisterDrCrTurnovers {
    private String name;
