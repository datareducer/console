...
/**
 * Класс для маршалинга неизменяемых объектов CalculationRegisterRecalculation
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "CalculationRegisterRecalculation")
@XmlType(name = "CalculationRegisterRecalculation")
public class AdaptedCalculationRegisterRecalculation {
    private String name;
    ...
    public void setRecalculationName(String recalculationName) {
