...
/**
 * Класс для маршалинга неизменяемых объектов AccountingRegisterTurnovers
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccountingRegisterTurnovers")
@XmlType(name = "AccountingRegisterTurnovers")
public class AdaptedAccountingRegisterTurnovers {
    private String name;
