...
/**
 * Исключение возникает, когда набор данных, возвращаемый RServe, содержит столбцы с одинаковыми именами.
 *
 * @author Kirill Mikhaylov
 */
public class DuplicateColumnException extends ReducerRuntimeException {
    /**
     * Создаёт исключение с сообщением, содержащим дублирующееся имя.
     *
     * @param msg Дублирующееся имя
     */
    DuplicateColumnException(String msg) {
        super("Имя столбца дублируется: " + msg);
    }
}
