...
public class ReducerRuntimeException extends RuntimeException {
    public ReducerRuntimeException() {
        super();
    }

    public ReducerRuntimeException(String msg) {
        super(msg);
    }

    public ReducerRuntimeException(Exception ex) {
        super(ex);
    }

    public ReducerRuntimeException(String msg, Exception ex) {
        super(msg, ex);
    }
}
