...
@XmlRootElement
public class AdaptedDataFrameRecord {
    private List<AdaptedDataFrameField> fields;

    public AdaptedDataFrameRecord() {
        fields = new ArrayList<>();
    }

    @XmlElement(name = "Field", namespace = "http://datareducer.ru/result")
    public List<AdaptedDataFrameField> getFields() {
        return fields;
    }

    public void setFields(List<AdaptedDataFrameField> fields) {
        this.fields = fields;
    }
}
