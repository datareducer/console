...
/**
 * Описание виртуальной таблицы фактического периода действия регистра расчета
...
public final class CalculationRegisterActualActionPeriod implements CalculationRegisterVirtualTable {
     ...
     * к виртуальным таблицам фактического периода действия регистра расчета
     */
    public static final String SUPERCLASS_NAME = "CalculationRegisterActualActionPeriod";
    ...
    /**
     * Создаёт описание запроса к виртуальной таблице фактического периода действия регистра расчета.
     *
     ...
     */
    public CalculationRegisterActualActionPeriod(String name, LinkedHashSet<Field> virtualTableFields, LinkedHashSet<Field> fieldsParam,
    ...
    /**
     * Создаёт описание виртуальной таблицы фактического периода действия регистра расчета.
     *
     * @param name               Имя Регистра расчета, как оно задано в конфигураторе.
     * @param virtualTableFields Поля Регистра расчета.
     */
    public CalculationRegisterActualActionPeriod(String name, LinkedHashSet<Field> virtualTableFields) {
    ...
    public String getMetadataName() {
        return "Фактический период действия";
    }

    @Override
    public String getMnemonicName() {
        return String.format("Фактический период действия регистра расчета \"%s\"", name);
    }

    @Override
    public String getType() {
        return getResourceName() + "_ActualActionPeriod";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CalculationRegisterActualActionPeriod)) {
            return false;
        }
        CalculationRegisterActualActionPeriod that = (CalculationRegisterActualActionPeriod) o;
