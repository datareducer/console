...
/**
 * Описание объекта конфигурации 1С - Плана обмена
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class ExchangePlan implements DataServiceRequest {
    /**
     * Префикс ресурса для обращения к REST-сервису 1С
     */
    public static final String RESOURCE_PREFIX = "ExchangePlan_";
    /**
     * Имя суперкласса для классов всех Планов обмена в кэше
     */
    public static final String SUPERCLASS_NAME = "ExchangePlan";
    /**
     * Ключевые поля
     */
    ...
    /**
     * Создаёт описание запроса к ресурсу Плана обмена.
     ...
     *
     * @param name        Имя Плана обмена, как оно задано в конфигураторе.
     ...
     */
    public ExchangePlan(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Плана обмена.
     *
     * @param name   Имя Плана обмена, как оно задано в конфигураторе.
     * @param fields Поля Плана обмена.
     */
    public ExchangePlan(String name, LinkedHashSet<Field> fields) {
    ...
    public String getMnemonicName() {
        return String.format("План обмена \"%s\"", name);
    }
    ...
    public boolean equals(Object o) {
        ...
        ExchangePlan that = (ExchangePlan) o;
