...
/**
 * Класс для маршалинга неизменяемых объектов ChartOfCalculationTypes
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "ChartOfCalculationTypes")
@XmlType(name = "ChartOfCalculationTypes")
public class AdaptedChartOfCalculationTypes {
    private String name;
