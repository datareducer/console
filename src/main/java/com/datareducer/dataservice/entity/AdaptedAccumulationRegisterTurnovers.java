...
/**
 * Класс для маршалинга неизменяемых объектов AccumulationRegisterTurnovers
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccumulationRegisterTurnovers")
@XmlType(name = "AccumulationRegisterTurnovers")
public class AdaptedAccumulationRegisterTurnovers {
    private String name;
