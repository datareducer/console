...
/**
 * Описание объекта конфигурации 1С - Документа
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class Document implements DataServiceRequest {
    /**
     * Префикс ресурса для обращения к REST-сервису 1С
     */
    public static final String RESOURCE_PREFIX = "Document_";
    /**
     * Имя суперкласса для классов всех Документов в кэше
     */
    public static final String SUPERCLASS_NAME = "Document";
    /**
     * Ключевые поля
     */
    ...
    /**
     * Создаёт описание запроса к ресурсу Документа.
     ...
     *
     * @param name        Имя Документа, как оно задано в конфигураторе.
     ...
     */
    public Document(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Документа.
     *
     * @param name   Имя Документа, как оно задано в конфигураторе.
     * @param fields Поля Документа.
     */
    public Document(String name, LinkedHashSet<Field> fields) {
    ...
    public String getMnemonicName() {
        return String.format("Документ \"%s\"", name);
    }
