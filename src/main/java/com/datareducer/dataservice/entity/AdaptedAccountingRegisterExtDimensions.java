...
/**
 * Класс для маршалинга неизменяемых объектов AccountingRegisterExtDimensions
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccountingRegisterExtDimensions")
@XmlType(name = "AccountingRegisterExtDimensions")
public class AdaptedAccountingRegisterExtDimensions {
    private String name;
