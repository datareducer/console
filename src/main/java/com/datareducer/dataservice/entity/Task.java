...
/**
 * Описание объекта конфигурации 1С - Задачи
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class Task implements DataServiceRequest {
    /**
     * Префикс ресурса для обращения к REST-сервису 1С
     */
    public static final String RESOURCE_PREFIX = "Task_";
    /**
     * Имя суперкласса для классов всех Задач в кэше
     */
    public static final String SUPERCLASS_NAME = "Task";
    /**
     * Ключевые поля
     */
    ...
    /**
     * Создаёт описание запроса к ресурсу Задачи.
     ...
     *
     * @param name        Имя Задачи, как оно задано в конфигураторе.
     ...
     */
    public Task(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Задачи.
     *
     * @param name   Имя Задачи, как оно задано в конфигураторе.
     * @param fields Поля Задачи.
     */
    public Task(String name, LinkedHashSet<Field> fields) {
    ...
    public String getMnemonicName() {
        return String.format("Задача \"%s\"", name);
    }
