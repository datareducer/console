...
public final class AccountingRegisterRecordsWithExtDimensions implements AccountingRegisterVirtualTable {
     ...
     * к виртуальным таблицам движений с субконто регистра бухгалтерии 1С в кэше.
     */
    public static final String SUPERCLASS_NAME = "AccountingRegisterRecordsWithExtDimensions";
