...
/**
 * Описание объекта конфигурации 1С - Плана видов характеристик
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class ChartOfCharacteristicTypes implements DataServiceRequest {
    /**
     * Префикс ресурса для обращения к REST-сервису 1С.
     */
    public static final String RESOURCE_PREFIX = "ChartOfCharacteristicTypes_";
    /**
     * Имя суперкласса для классов всех элементов Планов видов характеристик в кэше
     */
    public static final String SUPERCLASS_NAME = "ChartOfCharacteristicTypes";
    /**
     * Ключевые поля
     */
     ...
     */
    public ChartOfCharacteristicTypes(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Плана видов характеристик
     *
     * @param name   Имя Плана видов характеристик, как оно задано в конфигураторе.
     * @param fields Поля Плана видов характеристик.
     */
    public ChartOfCharacteristicTypes(String name, LinkedHashSet<Field> fields) {
    ...
    public String getMnemonicName() {
        return String.format("План видов характеристик \"%s\"", name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChartOfCharacteristicTypes)) {
            return false;
        }
