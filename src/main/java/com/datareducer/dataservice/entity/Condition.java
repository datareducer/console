...
import static com.datareducer.dataservice.entity.LogicalOperator.NOT;
...
public final class Condition implements FilterElement, Cloneable {
    ...
    public Condition append(FilterElement el) {
        if (el == NOT && !elements.isEmpty() && !(elements.get(elements.size() - 1) instanceof LogicalOperator)) {
