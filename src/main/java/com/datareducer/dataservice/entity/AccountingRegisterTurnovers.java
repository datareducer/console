...
/**
 * Описание виртуальной таблицы оборотов регистра бухгалтерии 1С
 ...
 */
public final class AccountingRegisterTurnovers implements AccountingRegisterVirtualTable {
    /**
     ...
     * к виртуальным таблицам оборотов регистров бухгалтерии 1С в кэше.
     */
    public static final String SUPERCLASS_NAME = "AccountingRegisterTurnovers";
    ...
    /**
     * Создаёт описание виртуальной таблицы оборотов регистра бухгалтерии.
     *
     * @param name       Имя Регистра бухгалтерии, как оно задано в конфигураторе.
     * @param properties Набор всех измерений, субконто и полей счетов виртуальной таблицы оборотов.
     * @param resources  Набор всех ресурсов виртуальной таблицы оборотов.
    ...
    public LinkedHashSet<Field> getExtDimensions() {
        ...
        result.add(getFieldByName("BalancedExtDimension1"));
        result.add(getFieldByName("BalancedExtDimension2"));
        result.add(getFieldByName("BalancedExtDimension3"));
        ...
        result.add(getFieldByName("BalancedExtDimension1_Type"));
        result.add(getFieldByName("BalancedExtDimension2_Type"));
        result.add(getFieldByName("BalancedExtDimension3_Type"));
        return result;
    }
    ...
    public Field getBalancedAccountField() {
        return getFieldByName("BalancedAccount_Key");
    }
    ...
    public String getType() {
        return getResourceName() + "_Turnovers";
    }
    ...
    public String getMnemonicName() {
        return String.format("Обороты регистра бухгалтерии \"%s\"", name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccountingRegisterTurnovers)) {
            return false;
        }
        AccountingRegisterTurnovers that = (AccountingRegisterTurnovers) o;
