...
public final class AccumulationRegister implements DataServiceRequest {
    ...
    /**
     * Имя суперкласса для классов всех Регистров накопления в кэше
     */
    public static final String SUPERCLASS_NAME = "AccumulationRegister";
    /**
     * Ключевые поля. Для Регистра накопления ключевыми являются поля Регистратора и Номера строки.
     ...
     * Таким образом, состав ключевых полей разных Регистров накопления различается.
     * По этой причине ключевые поля для суперкласса классов Регистров накопления в кэше не указываются.
     */
