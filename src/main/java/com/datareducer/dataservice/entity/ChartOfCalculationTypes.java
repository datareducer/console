...
/**
 * Описание объекта конфигурации 1С - Плана видов расчета
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class ChartOfCalculationTypes implements DataServiceRequest {
    /**
     * Префикс ресурса для обращения к REST-сервису 1С
     */
    public static final String RESOURCE_PREFIX = "ChartOfCalculationTypes_";
    /**
     * Имя суперкласса для классов всех Планов видов расчета в кэше
     */
    public static final String SUPERCLASS_NAME = "ChartOfCalculationTypes";
    /**
     * Ключевые поля
     */
    ...
    /**
     * Создаёт описание запроса к ресурсу Плана видов расчета.
     ...
     *
     * @param name        Имя Плана видов расчета, как оно задано в конфигураторе.
     ...
     */
    public ChartOfCalculationTypes(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Плана видов расчета.
     *
     * @param name   Имя Плана видов расчета, как оно задано в конфигураторе.
     * @param fields Поля Плана видов расчета.
     */
    public ChartOfCalculationTypes(String name, LinkedHashSet<Field> fields) {
    ...
    public String getMnemonicName() {
        return String.format("План видов расчета \"%s\"", name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChartOfCalculationTypes)) {
            return false;
        }
        ChartOfCalculationTypes that = (ChartOfCalculationTypes) o;
