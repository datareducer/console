...
/**
 * Класс для маршалинга неизменяемых объектов AccountingRegisterRecordsWithExtDimensions
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "AccountingRegisterRecordsWithExtDimensions")
@XmlType(name = "AccountingRegisterRecordsWithExtDimensions")
public class AdaptedAccountingRegisterRecordsWithExtDimensions {
    private String name;
