...
public final class AccountingRegisterDrCrTurnovers implements AccountingRegisterVirtualTable {
     ...
     * к виртуальным таблицам оборотов по регистру бухгалтерии 1С за произвольный период с определенной агрегацией в кэше.
     */
    public static final String SUPERCLASS_NAME = "AccountingRegisterDrCrTurnovers";
