...
/**
 * Класс для маршалинга неизменяемых объектов ChartOfCharacteristicTypes
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "ChartOfCharacteristicTypes")
@XmlType(name = "ChartOfCharacteristicTypes")
public class AdaptedChartOfCharacteristicTypes {
    private String name;
