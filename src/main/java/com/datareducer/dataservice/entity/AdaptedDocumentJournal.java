...
/**
 * Класс для маршалинга неизменяемых объектов DocumentJournal
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "DocumentJournal")
@XmlType(name = "DocumentJournal")
public class AdaptedDocumentJournal {
    private String name;
