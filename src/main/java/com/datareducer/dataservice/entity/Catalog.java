...
/**
 * Описание объекта конфигурации 1С - Справочника
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class Catalog implements DataServiceRequest {
    /**
     ...
     */
    public Catalog(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Справочника.
     *
     * @param name   Имя Справочника, как оно задано в конфигураторе.
     * @param fields Поля Справочника.
     */
    public Catalog(String name, LinkedHashSet<Field> fields) {
