...
/**
 * Описание объекта конфигурации 1С - Журнала документов
 * или запроса к соответствующему ресурсу REST-сервиса 1С.
 *
 * @author Kirill Mikhaylov
 */
public final class DocumentJournal implements DataServiceRequest {
    /**
     * Префикс ресурса для обращения к REST-сервису 1С
     */
    public static final String RESOURCE_PREFIX = "DocumentJournal_";
    /**
     * Имя суперкласса для классов всех  Журналов документов в кэше
     */
    public static final String SUPERCLASS_NAME = "DocumentJournal";
    /**
     * Ключевые поля
     */
    ...
    static {
        ...
        keyFields.add(new Field("Ref", FieldType.STRING, 1));
        keyFields.add(new Field("Ref_Type", FieldType.STRING, 2));
     ...
     */
    public DocumentJournal(String name, LinkedHashSet<Field> fields, boolean allFields, Condition condition, boolean allowedOnly) {
        if (name == null) {
    ...
    /**
     * Создаёт описание объекта конфигурации 1С - Журнала документов.
     *
     * @param name   Имя Журнала документов, как оно задано в конфигураторе.
     * @param fields Поля Журнала документов.
     */
    public DocumentJournal(String name, LinkedHashSet<Field> fields) {
    ...
    public String getMnemonicName() {
        return String.format("Журнал документ \"%s\"", name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentJournal)) {
            return false;
        }
