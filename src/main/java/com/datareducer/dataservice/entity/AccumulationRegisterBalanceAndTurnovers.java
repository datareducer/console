 ...
 */
public final class AccumulationRegisterBalanceAndTurnovers implements AccumulationRegisterVirtualTable {
    /**
     ...
     * к виртуальным таблицам оборотов регистров накопления 1С в кэше.
     */
    public static final String SUPERCLASS_NAME = "AccumulationRegisterBalanceAndTurnovers";
     ...
     * @param dimensionsParam Набор измерений, в разрезе которых будут получены остатки и обороты.
     * @param allDimensions   Остатки и обороты по всем измерениям. Используется для оптимизации запроса.
     * @param condition       Условие ограничения состава исходных записей,
     *                        по которым при построении виртуальной таблицы будут собираться остатки и обороты.
     ...
     */
    public AccumulationRegisterBalanceAndTurnovers(String name, LinkedHashSet<Field> dimensions, LinkedHashSet<Field> resources,
    ...
    /**
     * Создаёт описание виртуальной таблицы остатков и оборотов регистра накопления.
     *
     * @param name       Имя Регистра накопления, как оно задано в конфигураторе.
     * @param dimensions Набор всех измерений виртуальной таблицы остатков и оборотов.
     * @param resources  Набор всех ресурсов виртуальной таблицы остатков и оборотов.
    ...
    public String getType() {
        return getResourceName() + "_BalanceAndTurnover";
    }
    ...
    public String getMnemonicName() {
        return String.format("Остатки и обороты регистра накопления \"%s\"", name);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AccumulationRegisterBalanceAndTurnovers)) {
            return false;
        }
        AccumulationRegisterBalanceAndTurnovers that = (AccumulationRegisterBalanceAndTurnovers) o;
