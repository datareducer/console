...
/**
 * Класс для маршалинга неизменяемых объектов InformationRegister
 *
 * @author Kirill Mikhaylov
 */
@XmlRootElement(name = "InformationRegister")
@XmlType(name = "InformationRegister")
public class AdaptedInformationRegister {
    private String name;
