...
/*
 * Copyright (c) Kirill Mikhaylov, 2017-2018
 */
public class LoadConfigurationException extends RuntimeException {
    ...
    public LoadConfigurationException(String msg) {
        super(msg);
    }

    public LoadConfigurationException(Throwable ex) {
        super(ex);
    }

    public LoadConfigurationException(String msg, Throwable ex) {
        super(msg, ex);
    }
}
