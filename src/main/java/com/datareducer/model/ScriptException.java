...
/**
 * Возникает при ошибках выполнения скрипта R
 *
 * @author Kirill Mikhaylov
 */
public class ScriptException extends ReducerException {
    ScriptException() {
        super();
    }
    ...
    ScriptException(Exception ex) {
        super(ex);
    }

    ScriptException(String msg, Exception ex) {
        super(msg, ex);
    }
