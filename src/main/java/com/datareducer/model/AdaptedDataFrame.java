...
@XmlRootElement
public class AdaptedDataFrame {
    private List<AdaptedDataFrameRecord> records;

    public AdaptedDataFrame() {
    ...
    public void setRecords(List<AdaptedDataFrameRecord> records) {
